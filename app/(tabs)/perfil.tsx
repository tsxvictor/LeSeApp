...
const favoritos = [
  { id: 1, title: 'O Homem Invisível', author: 'H.G. Wells', image: require('@/assets/images/o-homem-invisivel.jpg') },
  { id: 2, title: 'Frankenstein', author: 'Mary Shelley', image: require('@/assets/images/frankenstein.jpg') },
];
...
const styles = StyleSheet.create({
  ...
  headerBg: {
    ...
    alignItems: 'center', marginHorizontal: 16, marginTop: 10, borderRadius: 25,
  },
